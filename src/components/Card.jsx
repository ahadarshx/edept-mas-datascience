export function Card({ className = '', children }) {
  return (
    <div
      className={`h-full rounded-xl border-[0.5px] border-neutral-200 bg-white p-6 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1 hover:rotate-1 hover:scale-[1.02] hover:border-neutral-400 hover:shadow-[0_16px_40px_rgb(0,0,0,0.08)] ${className}`}
    >
      {children}
    </div>
  )
